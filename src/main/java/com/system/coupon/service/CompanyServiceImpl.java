...
import com.system.coupon.data.db.*;
import com.system.coupon.data.ex.*;
import com.system.coupon.data.model.*;
...
//    }
    ...
    public Coupon updateCoupon(Coupon coupon) throws NoSuchCouponException {
        ...
        if (!optCoupon.isPresent()) {
            throw new NoSuchCouponException("There is no coupon with such id: " + coupon.getId());
        }
...
//            Company existCompany = company.get();
//            List<Coupon> coupons = existCompany.getCoupons();
//            coupons.remove(coupon);
//            existCompany.setCoupons(coupons);
//            couponRepo.deleteById(coupon_id);
//            System.out.println("Coupon was deleted successfully!");
//        } else throw new NoSuchCompanyException("No such company");
    }
